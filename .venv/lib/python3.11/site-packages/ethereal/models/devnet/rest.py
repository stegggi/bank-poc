...
#   timestamp: 2026-01-16T19:15:16+00:00
...
class ArchiveV1SubaccountBalanceGetParametersQuery(BaseModel):
    ...
    end_time: float | None = Field("2026-01-16T17:06:22.547Z", alias="endTime")
...
class ArchiveV1SubaccountFundingGetParametersQuery(BaseModel):
    ...
    cursor: str | None = None
    start_time: float = Field(..., alias="startTime")
    end_time: float | None = Field("2026-01-16T17:06:21.512Z", alias="endTime")
    order_by: OrderBy17 | None = Field(None, alias="orderBy", examples=["time"])
    subaccount_id: UUID = Field(
...
class ArchiveV1SubaccountUnrealizedPnlGetParametersQuery(BaseModel):
    ...
    cursor: str | None = None
    start_time: float = Field(..., alias="startTime")
    end_time: float | None = Field("2026-01-16T17:06:22.567Z", alias="endTime")
    resolution: Resolution = Field(..., examples=["hour2"])
    order_by: OrderBy17 | None = Field(None, alias="orderBy", examples=["time"])
    subaccount_id: UUID = Field(..., alias="subaccountId")
    product_ids: list[UUID] | None = Field(None, alias="productIds", min_length=1)
...
class ArchiveV1SubaccountVolumeGetParametersQuery(BaseModel):
    ...
    cursor: str | None = None
    start_time: float = Field(..., alias="startTime")
    end_time: float | None = Field("2026-01-16T17:06:22.577Z", alias="endTime")
    resolution: Resolution = Field(..., examples=["hour2"])
    order_by: OrderBy17 | None = Field(None, alias="orderBy", examples=["time"])
    subaccount_id: UUID = Field(..., alias="subaccountId")
